...
if __name__ == "__main__":
    ...
    question = "哪个国家定都于君士坦丁堡？"
    a, b, c = do_search(question)
    print(b)

    question = "塞尔柱苏丹是男的还是女的？"
    a, b, c = do_search(question)
    print(b)
    ...
    question = "在什么温度下艾氏剂密度为1.6？"
    a, b, c = do_search(question)
    print(b)

    question = "情绪抑郁的测量规范有多少个？"
    a, b, c = do_search(question)
    print(b)

    question = "有多少个关键人物与鲁米有关？"
    a, b, c = do_search(question)
    print(b)


    #### zh_linker_entities should be sliced in ner_entity_type_predict

    #### the US always have "哈瓦那" in 弗罗里达
    question = "哈瓦那在哪个国家？"
    a, b, c = do_search(question)
    print(b)

    ### edit ranking keywords in pid_zh_b_dict
    question = "海曙区在哪个城市？"
    a, b, c = do_search(question)
    print(b)
